...
//   return (
//     <div className="flex justify-center px-36 items-center mx-auto justify-between">
//       <div className="flex flex-col items-center w-full mx-auto p-5 bg-gray-50 rounded-lg shadow-lg">
//         <h1 className="text-2xl font-semibold text-center text-green-700 mb-4">Agriculture Chatbot</h1>
//         <div className="w-full h-80 overflow-y-auto p-3 bg-green-50 border border-gray-300 rounded-lg">
//           {chatHistory.length === 0 ? (
//             // Render the image if chat history is empty
//             <img
//               src="https://i.ibb.co/805PSzd/bot2.png"
//               alt="No messages"
//               className="mx-auto mt-10" // Center the image and add margin
//             />
//           ) : (
          ...
          {chatHistory.length === 0 ? (
            ...
            <div className="text-center bg-green">
              <img
                ...
                alt="No messages"
                className="mx-auto mt-5 h-44" // Center the image and add margin
                          />
